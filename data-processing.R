...
if(grepl('^/var/shiny/meta-analysis-shiny', getwd()) || grepl('/srv/shiny-server/meta-analyses-physical-activity', getwd())){
  ...
  # only for server
  raw_data <- read.csv("../meta-analysis/data/20171220_MASTER_PA_Dose_Metananalysis_Data_Extraction.csv", fileEncoding="latin1", 
                       header = T, stringsAsFactors = F, skipNul = TRUE)
}else{
  raw_data <- read.csv("../meta-analysis/data/20171220_MASTER_PA_Dose_Metananalysis_Data_Extraction.csv", header = T, 
